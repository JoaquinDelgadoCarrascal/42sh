...
int my_get_max(int, int);
int my_get_min(int, int);
...
//LISTS
t_list *add_end(t_list *, t_nodell *);
t_list *add_start(t_list *, t_nodell *);
t_list *add_index(t_list *, t_nodell *, int);
t_info_node *constructor_info_node(char *, char *);
t_nodell *constructor_node(t_info_node *);
t_list *delete_end(t_list *);
t_list *delete_index(t_list *, int);
t_list *delete_start(t_list *);
void free_list(t_list *);
void free_node(t_nodell *);
...
t_nodebt *constructor_nodebt(char *, t_nodebt *);
void free_bintree(t_binarytree *);
void inoder_traversal(t_binarytree *);
void postoder_traversal(t_binarytree *);
void preoder_traversal(t_binarytree *);
