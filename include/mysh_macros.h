...
#define TOTAL_ORIGINAL_BUILTINS 74
...
#define WHICH_ALIAS ": \t aliased to "
#define WHICH_BUILTIN ": shell built-in command.\n"
...
//FOREACH
#define FOREACH_TOO_FEW "foreach: Too few arguments.\n"
#define FOREACH_VAR_LETTER "foreach: Variable name must begin with a letter.\n"
#define FOREACH_PROMPT "foreach? "
#define FOREACH_NO_END "foreach: end not found.\n"
